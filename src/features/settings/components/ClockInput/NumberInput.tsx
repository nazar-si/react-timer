    ...
    ({ value, setValue, ...props }, ref) => {
      ...
      return (
        ...
        >
          ...
          <div className="text-3xl font-semibold font-mono h-8 w-8 items-center justify-center flex relative bg-black/5 overflow-hidden rounded-md dark:bg-white/5">
            {Array(props.max + 1)
              .fill(0)
              .map((_, i) => {
