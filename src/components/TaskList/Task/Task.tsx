...
const style = {
    wrapper: "grid grid-cols-[2rem_1fr_2rem] w-full gap-2 transition-all relative duration-200 ease-in-out",
...
export default function Task({task}: Props) {
    ...
    >
        ...
        <div className={classNames(style.grip, isUsed && "opacity-100", !isUsed && "scale-50 -left-4")}>
