...
export default function TaskList() {
  ...
  return (
    <div className="flex items-center flex-col gap-2 w-full">
        ...
        <button aria-label="add task" onClick={startCreating} className="w-full mb-10 font-medium text-zinc-400 dark:text-zinc-500 flex justify-center items-center gap-2 hover:bg-gray-200 dark:hover:bg-zinc-800/50 rounded-md px-2 py-1">Add task <IconPlus size={18}/></button>
    </div>
  )
}