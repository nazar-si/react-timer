...
export default function Example({value, onChange, checkmark, ...props}: Props) {
    ...
    >
      ...
      >
        <span
          ...
          aria-hidden="true"
        >
          {checkmark && <svg className="h-3 w-3 text-zinc-400" fill="none" viewBox="0 0 12 12">
            <path
        ...
        <span
          ...
          aria-hidden="true"
        >
          {checkmark && <svg className="h-3 w-3 text-blue-500" fill="currentColor" viewBox="0 0 12 12">
